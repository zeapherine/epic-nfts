...
contract MyEpicNFT is ERC721URIStorage {
    ...
    string[] firstWords = ["Fantastic", "Wonderful", "Incredible", "Great", "Super", "Awesome", "Fabulous", "Magnificent", "Fantabulous", "Fantastic", "Wonderful", "Incredible", "Hopeless"];
    string[] secondWords = ["Pizza", "Burger", "Fries", "HotDog", "Sandwich", "Cake", "Pie", "Cupcake", "Donut", "Cookie", "Candy", "IceCream", "Chocolate"];
    string[] thirdWords = ["Naruto", "Sasuke", "Sakura", "Kakashi", "Goku", "Gaara", "Minato", "Hinata", "Madara", "Obito", "Itachi", "Shikamaru", "Erza"];
